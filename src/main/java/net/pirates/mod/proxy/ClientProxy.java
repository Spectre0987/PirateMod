...
import net.pirates.mod.client.renderers.RenderCursedPirate;
...
public class ClientProxy extends ServerProxy{
	...
	public void preInit() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityPirateCursed.class, RenderCursedPirate::new);
	}
